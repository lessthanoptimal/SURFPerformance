...
public class VisualizeAssociatedFeatures {
	...
	public void associate() {
		...
		// load the features
		features1 = LoadBenchmarkFiles.loadDescription(directory+"DESCRIBE_"+name1+"_"+algSuffix+".txt");
		features2 = LoadBenchmarkFiles.loadDescription(directory+"DESCRIBE_"+name2+"_"+algSuffix+".txt");
