...
import boofcv.alg.feature.describe.DescribePointSurf;import boofcv.alg.feature.describe.SurfDescribeOps;import boofcv.factory.filter.kernel.FactoryKernelGaussian;
...
public class DescribePointSurfPanOMatic<II extends ImageSingleBand> extends DescribePointSurf<II> {
								 ...
								 SurfFeature ret )
	{
		...
		gradient.setScale(scale*1.65);

		zeroCmp();

		foo(c_x,c_y,scale*1.65,c,s);
